...
È importante sottolineare che, se ad esempio si configura una mappa con il solo backup sincrono, questa ottiene una consistenza forte, poiché le operazioni di inserimento e aggiornamento dei dati sulle repliche avvengono in modo sincrono.
